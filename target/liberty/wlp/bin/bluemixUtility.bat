...
set TOOL_JAVA_CMD_QUOTED=!JAVA_CMD_QUOTED! !JVM_ARGS! -jar "!WLP_INSTALL_DIR!\bin\tools/ws-bluemixUtility.jar"

@REM Execute the tool script or JAR.
if exist "!WLP_INSTALL_DIR!\lib\tools-internal/bluemixUtility.bat" goto:script
...
:script
set JAVA_RC=
call "!WLP_INSTALL_DIR!\lib\tools-internal/bluemixUtility" %*
if defined JAVA_RC (
  set RC=!JAVA_RC!
  call:javaCmdResult
)
